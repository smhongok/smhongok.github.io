...
\noindent
My research focuses on \textbf{physically valid generative AI} for imaging and sensing, integrating \textbf{computational imaging}, \textbf{inverse problems}, and \textbf{generative modeling} to build systems that move beyond visual plausibility toward numerical reliability.
I develop \textbf{optimization-driven methods} and efficient architectures with long-term goals in longitudinal predictive imaging, \textbf{cross-modal sensing}, and grounded world models for real-world deployment.
...
Computer Vision \ $\cdot$ \ Machine Learning \ $\cdot$ \ Computational Imaging \ $\cdot$ \ Inverse Problems \ $\cdot$ \ Optimization \ $\cdot$ \ Medical Imaging \ $\cdot$ \ Radar Signal Processing
